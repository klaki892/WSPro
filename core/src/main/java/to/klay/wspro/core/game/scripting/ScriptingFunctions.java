/*
package to.klay.wspro.core.game.scripting;
...
import to.klay.wspro.core.game.actions.GameAction;
import to.klay.wspro.core.game.actions.InvalidActionException;
import to.klay.wspro.core.api.cards.abilities.components.AbilityConditions;
import to.klay.wspro.core.api.game.LoseConditions;
import to.klay.wspro.core.game.formats.standard.cards.PlayingCard;
import to.klay.wspro.core.game.formats.standard.zones.DeckZone;
import to.klay.wspro.core.game.formats.standard.zones.BasePlayZone;
import to.klay.wspro.core.game.formats.standard.zones.WaitingRoomZone;

import java.util.Collections;
import java.util.List;

import static to.klay.wspro.core.game.actions.DuelUtil.checkIfWorked;
...
/**
    ...
    public to.klay.wspro.core.api.game.field.PlayZone getZone(Zones zone){
...
/**
    ...
    public to.klay.wspro.core.api.game.field.PlayZone getZone(GamePlayer targetPlayer, Zones targetZone){
        for (to.klay.wspro.core.api.game.field.PlayZone playZone : game.getPlayingField()){
...
/**
    ...
    private static boolean moveCard(PlayingCard card, to.klay.wspro.core.api.game.field.PlayZone sourceZone, to.klay.wspro.core.api.game.field.PlayZone destinationZone) throws InvalidActionException{
